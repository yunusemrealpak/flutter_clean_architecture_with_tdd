...
import 'package:flutter_clean_architecture/src/core/network/dio_client.dart' as _i16;
import 'package:flutter_clean_architecture/src/core/network/dio_client_config.dart' as _i4;
import 'package:flutter_clean_architecture/src/core/network/network_info.dart' as _i8;
import 'package:flutter_clean_architecture/src/core/network/token/token_provider.dart' as _i5;
...
import 'package:flutter_clean_architecture/src/features/splash/presentation/bloc/splash_bloc.dart'
    as _i17;
import 'package:flutter_clean_architecture/src/infrastructure/di/injection_module.dart' as _i22;
import 'package:flutter_clean_architecture/src/infrastructure/network/token/app_token_provider.dart'
    as _i6;
import 'package:get_it/get_it.dart' as _i1;
import 'package:injectable/injectable.dart' as _i2;
import 'package:internet_connection_checker/internet_connection_checker.dart' as _i7;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i7.InternetConnectionChecker>(() => injectionModule.connectionChecker);
    ...
    gh.lazySingleton<_i10.SplashLocalDataSource>(
        () => _i10.SplashLocalDataSourceImpl(sharedPreferences: gh<_i9.SharedPreferences>()));
    ...
    gh.lazySingleton<_i14.CheckAppVersion>(() => _i14.CheckAppVersion(gh<_i12.SplashRepository>()));
    gh.lazySingleton<_i15.CheckUserToken>(() => _i15.CheckUserToken(gh<_i12.SplashRepository>()));
    ...
    gh.factory<_i21.GetSavedUser>(() => _i21.GetSavedUser(gh<_i19.AuthRepository>()));
    return this;
  }
}
